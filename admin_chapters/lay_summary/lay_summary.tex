\chapter{Lay Summary}
Data today often forms large networks: people connected through social media, money flowing between banks, vehicles moving across road systems.
...
This thesis presents a single system that handles both storage and analysis together on one machine, even when the data is too large to fit in memory.
