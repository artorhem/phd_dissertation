...
## Chapter 3: Related Work and Design Space
...
### 3.1 Property Graphs vs. Structural Graphs **[BOTH]**
...
### 3.2 Static Graph Processing Systems **[BOTH]**
...
#### 3.2.1 In-Memory Graph Processing Systems
...
## Chapter 4: Structural Graph Storage
...
#### 4.7.2 Transactional Bulk Loader
...
## Chapter 5: Property Graph Storage
...
### 5.2 Label Encoding **[CANDIDACY -- more detailed; BOTH for chosen approach]**
...
### 5.3 Embedded (Inline) Property Storage **[MAIN]**
...
### 5.4 Columnar Property Storage **[MAIN]**
...
## Chapter 6: Evaluation -- Static Graph Analytics
...
## Chapter 7: Evaluation -- Dynamic Structural Graphs
...
## Chapter 8: Evaluation -- Property Graph Workloads
...
### 8.2 Query Implementation Methodology **[TO WRITE]**
...
### 8.7 Microbenchmarks Against Graph Databases **[MAIN]**
...
## Chapter 9: Future Work **[TO WRITE]**
...
### 9.2 Concurrent Analytics Under Mutation **[MAIN]**
- Current model: analytics run on read-only snapshots; writers proceed concurrently but analytics see a frozen view
- Goal: incremental or streaming analytics that incorporate mutations without full recomputation
- Challenge: maintaining consistency guarantees while allowing analytics to observe in-flight changes
- Related work: GraphBolt, Kickstarter (batched incremental), Tegra (streaming snapshots)
