...
\begin{table}[h]
  ...
  \begin{tabularx}{\columnwidth}{|X|r|r|r|r|}
    \hline
    \textbf{Component} & \textbf{w=1 (ns)} & \textbf{\%} & \textbf{w=72 (ns)} & \textbf{Growth} \\
    \hline
    ...
    \hline
    \textbf{Writer on-CPU total}      & \textbf{13,822} & & \textbf{45,662} & $\times$\textbf{3.3} \\
    \hline
  \end{tabularx}
...
\begin{table}[h]
  \centering
  \begin{tabularx}{\columnwidth}{|X|r|r|X|}
    \hline
    \textbf{Category} & \textbf{w=1} & \textbf{w=72} & \textbf{Why it exists} \\
    \hline
