...
Absent high-degree vertices, concurrent appends spread evenly across adjacency records rather than concentrating on a few hot lists, eliminating the contention that penalised the wider thread pool on the power-law graph.
