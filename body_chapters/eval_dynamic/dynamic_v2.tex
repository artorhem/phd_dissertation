...
However, GraphOne, despite leading the insertion benchmark, collapses to 0.05 \, M~ops/s, a \textcolor{red}{114}$\times$ drop.
...
\project{} EdgeKey sustains \textcolor{red}{1.07}\,M~ops/s, and LiveGraph sustains 0.42\,M~ops/s.
...
\textcolor{red}{The uniform-24 dataset, which lacks high-degree hub vertices, reveals how much of the update behaviour is driven by degree skew.
...
Under power-law degree distributions, concurrent writers issue conflicting modifications to the records of high-degree vertices, producing a high rollback rate that \textcolor{red}{peaks near ${\sim}$1.0\,M~edges/s at ${\sim}$48 threads and declines to ${\sim}$0.72\,M~edges/s at 72~threads}.
