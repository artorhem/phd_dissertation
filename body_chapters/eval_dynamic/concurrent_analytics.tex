...
\begin{figure}[!htb]
  ...
  These explicit checkpoints reduce writerer throughput to a mean value of $290$\,K\,ops/s in the first pass and $95$\,K\,ops/s in the second pass, and the recoveries between checkpoints are the only work they get done.
...
Reuse buys an order of magnitude over forcing, but the writers still stop before five passes complete.

Checkpoint reuse removes the forced checkpoints, not all checkpoints.
