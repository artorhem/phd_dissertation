...
Because vertices can read the most recent values written by any neighbor, asynchronous execution often converges faster than BSP for algorithms whose correctness does not depend on seeing a globally consistent snapshot (e.g., PageRank, label propagation).
...
\subsection{Subgraph-Centric Models}
