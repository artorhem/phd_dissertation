...
\begin{figure}[t]
  ...
  \caption{Out-of-core graph analytics. Solid bars: combined PageRank + CC time. Hatched: preprocessing time. Note the log Y axis; preprocessing time often dominates runtime.}
