...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}[scale=0.85, every node/.style={transform shape},
    ...
    \node[class] (wtnpc) at (-2.5, -1.8) {WTNodePropCursor};
    \node[class] (embnpc) at (2.5, -1.8) {EmbNodePropCursor};

    % EdgePropCursor hierarchy
    \node[abstract] (epc) at (7.5, 0) {EdgePropCursor};
    \node[class] (wtepc) at (5.0, -1.8) {WTEdgePropCursor};
    \node[class] (embepc) at (10.0, -1.8) {EmbEdgePropCursor};
