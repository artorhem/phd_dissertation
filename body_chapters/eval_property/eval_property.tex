...
Third, we run iterative algorithms on the full cit-Patents graph and compare \project{} against graph database baselines~(\autoref{sec:eval:property-graphalytics}).
