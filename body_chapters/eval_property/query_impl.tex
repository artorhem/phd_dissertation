...
Edge property schemas follow the same pattern.
...
The LLM generated the routing function that dispatches \code{get\_edge\_properties} to the correct \wt{} property table based on the \code{(src\_type, dst\_type)} pair extracted from the vertex IDs.
...
Each \project{} query implementation was validated against Neo4j by running both systems on the same LDBC SNB SF-3 dataset and comparing results field-by-field.
