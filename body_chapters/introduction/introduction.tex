...
That independence lets each property be stored in the representation its access pattern demands — inline with the record it belongs to, or in a column group scanned in bulk — chosen per label rather than globally.
