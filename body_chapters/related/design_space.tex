...
All static systems, whether in-memory or out-of-core, require an offline preprocessing step to build their layout and are batch-only, supporting no mutation during processing.
Among the out-of-core systems to which we compare, GraphChi is a partial exception: it includes an evolving-graph mode that can append edges during execution.
