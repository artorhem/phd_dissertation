...
The sequential CSV read and the forward-adjacency-list writes dominate Pass~1; the two \texttt{tbb::parallel\_sort} calls on the reverse-edge chunks account for only 16 of its 310 seconds.
