...
When the buffer reaches a configurable size (default 10\,GB, approximately 625M edges), the program sorts the chunk with \texttt{tbb::parallel\_sort} and flushes it to a binary run file on disk.
