...
The preprocessing pipeline uses a two pass design and uses parallel sorting:
...
\]
where subscripts denote indices, superscripts denote bit widths, d is the degree (stored as a 32-bit integer) and each field is written in its native binary representation.
