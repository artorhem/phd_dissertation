...
\PM{DO NOT READ -- FROM PREVIOUS DRAFT}\\\\
...
Talk about CSR/CSC, adjacency Lists, and EdgeLists. Maybe TEL and EdgeLogs
\subsubsection{Compressed Sparse Row}
\label{sec::background::CSR}

\subsubsection{Adjacency Lists}
\label{sec::background::adjlist}

\subsubsection{Edge Logs or Edge Lists}
\label{sec::background::edgelog}
