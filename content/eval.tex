...
We plan to use Grafaree to evaluate the performance of ~\project{} on dynamic graph processing workloads, and there is still some work to be done to get the \project{} driver ready for Grafaree (the timeline for this is discussed in Section~\autoref{sec:future-timeline}).
