...
3. Computational Model:
	...
	- In a single-node system, the computation model defines:
		(i) [IO]is A read in its entirety each time, or is there some reasonable way to access a subgraph, ideally only the neighborhood needed (all: naive linear algebra, smart whole matrix: x-stream, only relevant edges: most systems)
